        ...
        <div class="wrapper">
            <div class="side-bar">
                <ul>
                    ...
                    <div class="menu">              
                        <li><a href="?request_action=authenticate" id="authenticate">Authentication</a></li>
                        <li><a href="?request_action=serviceAvailability" id="serviceAvailability">
                                Service Availability
                            </a>
                        </li>
                        <li><a href="?request_action=authAndCapture" id="authAndCapture">Auth Capture</a></li>
                        <li><a href="?request_action=authorization" id="authorization">Authorization</a></li>
                        <li><a href="?request_action=ccReverse" id="ccReverse">Reverse</a></li>
                        <li><a href="?request_action=capture" id="capture">Capture</a></li>
                        <li><a href="?request_action=ccCredit" id="ccCredit">Credit</a></li>
                        <li><a href="?request_action=ccStatus" id="ccStatus">Status</a></li>
                        <li><a href="?request_action=creditOnFail" id="creditOnFail">Credit On Fail</a></li>
                        <li><a href="?request_action=forceCredit" id="forceCredit">Force Credit Request</a></li>
