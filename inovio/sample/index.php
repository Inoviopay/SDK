		...
		<div class="side-bar">
			<ul>
				<li class="menu-head">
					...
					<a href="#" class="push_menu visible-xs">
				...
				<div class="menu">
					<li>
						<a href="?request_action=authenticate" id="authenticate">Authentication</a>
					</li>
				</div>
			</ul>
		</div>
							...
							<div class="panel-body">
								<div class="panel-body">
									<div class="form-group">
										<textarea name="postdata" id="postdata" rows="25" class="form-control" placeholder="Request parameters">
<?php echo $txtParam; ?>
                                            </textarea>
									</div>
								</div>
					...
					<div class="col-md-2 text-center btn_mg">
						<div class="center-text">
							...
							<input type="submit" value="Execute" class="btn col-lg-8 btn-warning btn-lg btn-sunny execute-btn">
							<input type="button" class="col-lg-8 default-button medium inovioreset-button" value="Reset">
							<input type="button" data-toggle="modal" data-target="#myModal" class="col-lg-8 green-button medium explore-source-code"
							 value="Source code">
						</div>
					</div>
	...
	<footer class="Footer bg-dark dker">
		<span>
			<?php echo date('Y'); ?>&copy; Inovio Payment Gateway API</span>
	</footer>
